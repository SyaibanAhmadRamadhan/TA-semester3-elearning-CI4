                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left" action="" method="post" enctype="multipart/form-data" novalidate>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="tel" class="form-control col-md-7 col-xs-12" required="required" id="nisn" name="nisn" data-validate-linked="hid1" placeholder="Enter a nomer induk siswa nasional..">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" class="form-control col-md-7 col-xs-12" required id="npsn" name="npsn" placeholder="Enter a nomer pokok sekolah nasional.." data-validate-linked="hid3">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" class="form-control col-md-7 col-xs-12" required="required" id="wali" name="wali" placeholder="Enter a wali..">
                                        </div>
                                    </div>
                                    <div class="item form-group">
