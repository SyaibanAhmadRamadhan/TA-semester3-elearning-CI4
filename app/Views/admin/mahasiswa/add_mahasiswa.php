                                ...
                                <form class="form-valide" action="" method="post" enctype="multipart/form-data">
                                    <?= csrf_field(); ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="npsn" name="npsn" placeholder="Enter a nomer pokok sekolah nasional..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <input type="text" name="hid1" id="hid1">
                                        <input type="text" name="hid2" id="hid2">
                                        </div>
                                    </form>
                                </div>
                            </div>
        ...
        $('#nisn').keyup(function(){
            ...
            if (nisn != ''){
                $.ajax({
                    ...
                    method: 'post',
                    dataType:"JSON",
                    data: {nisn: nisn,[csrfName]: csrfHash},
                    success: function(data){
                        let id = document.getElementById('uname_response');
        ...
        $('#no_telepon').keyup(function(){
            ...
            if (no_telepon != ''){
                $.ajax({
                    ...
                    method: 'post',
                    dataType:"JSON",
                    data: {no_telepon: no_telepon,[csrfName]: csrfHash},
                    success: function(data){
                        let id = document.getElementById('uname_response');
                        let hidNisn = document.getElementById('hid1').value;
                        let hidEmail = document.getElementById('hid').value;
