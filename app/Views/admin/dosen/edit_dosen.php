                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left" action="" method="post" enctype="multipart/form-data" novalidate>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" class="form-control col-md-7 col-xs-12" required="required" id="asal_universitas" name="asal_universitas" placeholder="Enter a nomer induk siswa nasional.." value="<?= $data->asal_universitas ?>">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control filter_wilayah" id="gelar" name="gelar[]" required="required" type="select" multiple>
                                                ...
                                                <?php
                                                foreach ($gelar as $x) : ?>
                                                    <option value="<?= $x['id'] ?>" <?php foreach ($dataDaftarGelar as $p) {
                                                                                        if ($x['id'] == $p[0]['id']) {
                                                                                            echo 'selected';
                                                                                        } else {
                                                                                            echo '';
                                                        ...
                                                        <?= $x['program_studi'], ' ', $x['jengjang'] ?> || <?= $x['gelar'] ?>
                                                    </option>
                                                <?php endforeach ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control filter_wilayah" id="kelas" name="kelas[]" required multiple>
                                                ...
                                                <?php
                                                foreach ($kelas as $x) : ?>
                                                    <option value="<?= $x['id'] ?>" <?php foreach ($dataDaftarKelas as $p) {
                                                                                        if ($x['id'] == $p[0]['id']) {
                                                                                            echo 'selected';
                                                                                        } else {
                                                                                            echo '';
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <img src="<?= base_url("uploads/picture/dosen/" . $data->picture) ?>" class="img-show mb-3 img-fluid rounded d-block" style="height: 200px" id="foto" alt=""><br><br>
                                    ...
                                    <input type="hidden" value="<?= $data->nip_dosen ?> " id="nip">
                                </form>
                            </div>
                        </div>
                    </div>
