                        ...
                        <div class="x_panel">
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left" action="" method="post" enctype="multipart/form-data" novalidate>
                                    ...
                                    <div class="item form-group">
                                        <input type="hidden" name="validateKode" id="validateKode" value="<?= $dataMatkul['kode_matkul'] ?>">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="kode">kode matakuliah <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" class="form-control col-md-7 col-xs-12" required="required" data-validate-linked="validateKode" id="kode" name="kode" placeholder="Enter a kode matakuliah.." value="<?= $dataMatkul['kode_matkul'] ?>">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <p>Jika Anda Meng-edit file materi, maka file materi yang sebelumnya akan terhapus</p>
                                        </div>
                                    </div>
                                    ...
                                    <input type="hidden" id="created_at" value="<?= $dataMatkul['created_at'] ?>">
                                </form>
                            </div>
                        </div>
                    </div>
